export const WORKOUTS = Object.freeze([
  ...
  Object.freeze({ id: 'legs-b', day: 5, short: 'LEGS B', title: 'Legs Hypertrophy + Abs', targets: Object.freeze(['Quads', 'Hamstrings', 'Calves', 'Core']), exercises: 8, sets: 30, minutes: 86, image: '/assets/workout-images/anatomy_images.png' }),
