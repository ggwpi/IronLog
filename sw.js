const CACHE = 'ironlog-foundation-v7';
const CORE = [
  ...
  '/src/anatomy/back.js', '/src/anatomy/abs.js', '/src/anatomy/quads.js', '/src/anatomy/hamstrings.js',
  '/src/anatomy/glutes.js', '/src/anatomy/calves.js',
];
